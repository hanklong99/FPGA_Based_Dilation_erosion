...
//-------------------------------------------------------
//wire flag = (img_Cr_r1 > 133 && img_Cr_r1 < 173 && img_Cb_r1 > 77 && img_Cb_r1 < 127)? 1'b1: 1'b0;
reg     [7:0]   skin_data;
always @(posedge clk or negedge rst_n)begin
    if(rst_n == 1'b0)begin
        skin_data <= 0;
    end
    else if((img_Cr_r1 > 133 && img_Cr_r1 < 173) && (img_Cb_r1 > 77 && img_Cb_r1 < 127))begin
        skin_data <= 8'hff;
    end
    else
        skin_data <= 8'h00;
...
assign	post_img_Y 	= 	post_frame_href ? skin_data : 8'd0;
